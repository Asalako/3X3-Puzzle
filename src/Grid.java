...
public class Grid {
	...
	public static void main(String[] args) throws IOException {
		...
		State state1 = new State( State.stateValidation(scanner.next()) );
		...
		if (scanner.next().toLowerCase().equals("y")) {
			state2.writeState(10, "state2.txt");
		}
		...
		System.out.println("Number of states in State 1: " + state1.getTraversedStates().size());
